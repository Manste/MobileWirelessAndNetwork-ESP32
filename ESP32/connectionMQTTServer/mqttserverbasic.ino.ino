...
#define MQTT_USERNAME    "esp1234"                // Leave blank for anonymous vGlrsiXas6m6rB1EeP1F
#define MQTT_PASSWORD    "TR4oah9FT1PDf5WWEP5N"                // Leave blank for anonymous
...
void loop() {
  ...
  mqtt.processPackets(10000); // Process MQTT packets
